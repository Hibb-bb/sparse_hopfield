...
class EntmaxHopfieldEncoderLayer(Module):
    ...
    def __init__(self,
        ...
        """
        super(EntmaxHopfieldEncoderLayer, self).__init__()
...
class EntmaxHopfieldDecoderLayer(Module):
    """
    Module with underlying Hopfield associations to be used as a decoder in transformer-like architectures.
    """

    def __init__(self,
                 hopfield_association_self: EntmaxHopfield,
                 hopfield_association_cross: EntmaxHopfield,
                 dim_feedforward: int = 2048,
                 dropout: float = 0.1,
                 activation: str = r'relu'
                 ):
        ...
        :param activation: activation to be applied on the result of the internal linear projections
        """
        super(EntmaxHopfieldDecoderLayer, self).__init__()
