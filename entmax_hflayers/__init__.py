...
class EntmaxHopfield(Module):
    ...
    def __init__(self,
        ...
        """
        super(EntmaxHopfield, self).__init__()
...
class EntmaxHopfieldPooling(Module):
    """
    ...
    def __init__(self,
        ...
        """
        super(EntmaxHopfieldPooling, self).__init__()
        self.hopfield = EntmaxHopfield(
...
class EntmaxHopfieldLayer(Module):
    """
    ...
    def __init__(self,
        ...
        """
        super(EntmaxHopfieldLayer, self).__init__()
        self.hopfield = EntmaxHopfield(
            input_size=input_size, hidden_size=hidden_size, output_size=output_size, pattern_size=pattern_size,
            num_heads=num_heads, scaling=scaling, update_steps_max=update_steps_max, update_steps_eps=update_steps_eps,
            normalize_stored_pattern=normalize_stored_pattern,
