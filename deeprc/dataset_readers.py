...
class RepertoireDataset(Dataset):
    def __init__(self, metadata_filepath: str, hdf5_filepath: str, inputformat: str = 'NCL',
                 sample_id_column: str = 'Subject ID', metadata_file_column_sep: str = '\t',
        ...
        with h5py.File(self.filepath, 'r') as hf:
            ...
            if np.any(unfound_samples):
                # pass
                # print(len(unfound_samples))
                # print(f"Samples {self.sample_keys[unfound_samples]} ")
